...
public class AsyncQueryServiceHelper extends IntentService {
    ...
    protected static class OperationInfo implements Delayed{
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || !(o instanceof OperationInfo)) {
                return false;
            }
            if (((OperationInfo) o).mScheduledTimeMillis == this.mScheduledTimeMillis) {
                isEqual = true;
            }
            return isEqual;
        }
        ...
        @Override
        public int hashCode() {
            return (int)(mScheduledTimeMillis ^ (mScheduledTimeMillis >>> 32));
        }
        /* @} */
    ...
    static public void queueOperation(Context context, OperationInfo args) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            context.startForegroundService(new Intent(context, AsyncQueryServiceHelper.class));
        } else {
        ...
        if (resolver != null) {
            ...
            switch (args.op) {
                ...
                case Operation.EVENT_ARG_DELETE:
                    ...
                    /** Fix bug 610083, Delete calendar caused application crash {@ **/
