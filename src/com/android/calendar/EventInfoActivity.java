...
public class EventInfoActivity extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (icicle != null) {
            ...
            attendeeResponse = icicle
                    .getInt(EventInfoFragment.BUNDLE_KEY_ATTENDEE_RESPONSE);
            isDialog = icicle
                    .getBoolean(EventInfoFragment.BUNDLE_KEY_IS_DIALOG);
        ...
        if (mEventId == -1) {
            ...
            Toast.makeText(this, R.string.event_not_found, Toast.LENGTH_SHORT)
                    .show();
            finish();
        }
        ...
        mInfoFragment = (EventInfoFragment) getFragmentManager()
                .findFragmentById(R.id.main_frame);

        // Remove the application title
        ActionBar bar = getActionBar();
        bar.setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM);
        bar.setCustomView(R.layout.event_info_custom_actionbar);
        View actionView = bar.getCustomView();

        ImageView upButton = (ImageView) actionView
                .findViewById(R.id.action_info_back);
        ...
        if (mInfoFragment == null) {
            ...
            mInfoFragment = new EventInfoFragment(this, mEventId, mStartMillis,
                    mEndMillis, attendeeResponse, isDialog,
                    (isDialog ? EventInfoFragment.DIALOG_WINDOW_STYLE
                            : EventInfoFragment.FULL_WINDOW_STYLE), reminders);
    ...
    protected void onDestroy() {
        if (mInfoFragment != null) {
            mInfoFragment.dismissReadUserDataDialog();
        }
        super.onDestroy();
    }
    /* @} */
    ...
    /*
     * SPRD: for bug557603, com.android.calendar happens
