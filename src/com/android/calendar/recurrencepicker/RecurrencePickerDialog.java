...
public class RecurrencePickerDialog extends DialogFragment implements OnItemSelectedListener,
    ...
    private static final String END_COUNT_MARKER = "%d";//UNISOC: Modify for bug1213742
...
//                    }
    ...
    public void onClick(View v) {
        ...
        if (mEndDateTextView == v) {
            ...
            /* UNISOC: Modify for bug1232836 @{ */
            final DateListener listener = new DateListener();
            mDatePickerDialog = new DatePickerDialog(getActivity(), listener,
    ...
    private class EndSpinnerAdapter extends ArrayAdapter<CharSequence> {
        private static final String END_DATE_MARKER = "%s";//UNISOC: Modify for bug1213742
