...
public class CalendarAppWidgetService extends RemoteViewsService {
    ...
    public static class CalendarFactory extends BroadcastReceiver implements
        ...
        //private int mDeclinedColor;//UNISOC: Modify for bug1211071
        //private int mStandardColor;//UNISOC: Modify for bug1211071
        ...
        protected CalendarFactory(Context context, Intent intent) {
            ...
            //mDeclinedColor = mResources.getColor(R.color.appwidget_item_declined_color); //UNISOC: Modify for bug1211071
            //mStandardColor = mResources.getColor(R.color.appwidget_item_standard_color); //UNISOC: Modify for bug1211071
        }
            ...
            if (rowInfo.mType == RowInfo.TYPE_DAY) {
                ...
                if (eventInfo.allDay) {
                    if (selfAttendeeStatus == Attendees.ATTENDEE_STATUS_INVITED) {
                        ...
                        mAllDayColor = mResources.getColor(R.color.appwidget_item_allday_color); // UNISOC: Modify for bug1227302
