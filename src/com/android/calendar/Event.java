...
public class Event implements Cloneable {
    ...
    public String eventTimezone; // UNISOC: Modify for bug1169506
    ...
    public final Object clone() throws CloneNotSupportedException {
        ...
        e.eventTimezone = eventTimezone; // UNISOC: Modify for bug1169506
    ...
    public final void copyTo(Event dest) {
        ...
        dest.eventTimezone = eventTimezone; // UNISOC: Modify for bug1169506
    }
    ...
    public static final Event newInstance() {
        ...
        e.eventTimezone = ""; // UNISOC: Modify for bug1169506
    ...
    private static final Cursor instancesQuery(ContentResolver cr, String[] projection,
        ...
        /* SPRD: Modify for bug 716310 @{ */
        Cursor cursor = null;
        cursor = cr.query(builder.build(), projection, selection, selectionArgs,
    ...
    private static Event generateEventFromCursor(Cursor cEvents) {
        ...
        e.eventTimezone = cEvents.getString(PROJECTION_TIMEZONE_INDEX); // UNISOC: Modify for bug1169506
