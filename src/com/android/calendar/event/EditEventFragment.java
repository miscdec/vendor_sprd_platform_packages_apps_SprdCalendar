...
public class EditEventFragment extends Fragment implements EventHandler, OnColorSelectedListener {
    ...
    //SPRD: Add for bug415511/576245, switch screen, attendees data lose.
    private static final String BUNDLE_KEY_VITSITCONTACT = "mVisitContact";
...
//        mContext.requestWindowFeature(Window.FEATURE_INDETERMINATE_PROGRESS);
        ...
        mView = new EditEventView(mActivity, view, mOnDone, mTimeSelectedWasStartTime,
                mDateSelectedWasStartDate, mVisitContact, mIsAvailabilityExplicitlySet);
        startQuery();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        synchronized (this) {
            if (savedInstanceState != null) {
                ...
                //SPRD: Add for bug415511/576245, switch screen, attendees data lose.
                if (savedInstanceState.containsKey(BUNDLE_KEY_VITSITCONTACT)) {
                    mVisitContact = savedInstanceState.getBoolean(BUNDLE_KEY_VITSITCONTACT);
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        /* UNISOC: Modify for bug1219671  {@ */
        if (onActionBarItemSelected(item.getItemId())) {
            return true;
        }
    ...
    public void dismissNoCalendarsDialog() {
        if (mView.mNoCalendarsDialog != null && mView.mNoCalendarsDialog.isShowing()) {
            mView.mNoCalendarsDialog.dismiss();
            mView.mNoCalendarsDialog = null;
        }
    }
    /* @} */
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (mEventBundle == null && mEvent != null) {
            ...
            if (mEvent.endTime != null) {
                mEventBundle.end = mEvent.endTime.toMillis(true);// UNISOC: Modify for bug1206642
            }
        }
        ...
        //SPRD: Add for bug415511/576245, switch screen, attendees data lose.
        outState.putBoolean(BUNDLE_KEY_VITSITCONTACT, mVisitContact);
    }
