...
//        Utils.setStatusBarColor(this);         //Sprd modify for bug773640
        ...
        //SPRD: Add for bug569477, tip read contact.
        mIsVisitContact = getIntent().getBooleanExtra(CalendarController.VISIT_CONTACT, true);
        ...
        if (mEditFragment == null) {
            ...
            mEditFragment = new EditEventFragment(mEventInfo, mReminders, mEventColorInitialized,
                    mEventColor, false, intent, mIsVisitContact);
    ...
    protected void onDestroy() {
        mEditFragment.dismissNoCalendarsDialog();
        super.onDestroy();
    }
    /* @} */
