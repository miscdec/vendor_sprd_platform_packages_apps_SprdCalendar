...
public class AttendeesView extends LinearLayout implements View.OnClickListener {
    ...
    private boolean mIsReadContact;
    ...
    private View updateAttendeeView(AttendeeItem item) {
        ...
        //SPRD: Add for bug569477, tip read contact.
        nameView.setText((TextUtils.isEmpty(attendee.mName) || !mIsReadContact) ? attendee.mEmail : attendee.mName);
        if (item.mRemoved) {
    ...
    /* SPRD: Add for bug569477, tip read contact. @{ */
    public void addAttendees(ArrayList<Attendee> attendees, boolean isReadContact) {
        mIsReadContact = isReadContact;
        synchronized (this) {
