...
public class SimpleWeekView extends View {
    ...
    public void setWeekParams(HashMap<String, Integer> params, String tz) {
        ...
        int i = 0;
        if (mShowWeekNum) {
            /* SPRD: Add for bug556612, The first week displays error on month view. @{ */
            if (0 == mWeek) {
                mDayNumbers[0] = "1";
            } else {
        ...
        for (; i < mNumCells; i++) {
            ...
            if(Utils.mSupportForeignFestivalCalendar){
                ...
                mForeignFestivalCalendar.setDate(time.year,
                        time.month, monthDay);
                mLunarDayNumbers[i] = mForeignFestivalCalendar.getForeignFestivalInfo();
