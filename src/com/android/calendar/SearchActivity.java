...
public class SearchActivity extends Activity implements
        CalendarController.EventHandler, SearchView.OnQueryTextListener,
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /* SPRD: bug717911, add auto search for search app @{ */
            ...
            SearchIntent.setData(detailUri);
            SearchIntent.setClass(this, EventInfoActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (Utils.isJellybeanOrLater()) {
            ...
            // Utils.setTodayIcon(
            // icon, this, Utils.getTimeZone(SearchActivity.this,
            // mTimeChangesUpdater));
        } else {
        ...
        /*UNISOC: Modify for bug 1164646,1224511 @{*/
        if (mSearchView != null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.action_today) {
            t = new Time();
            t.setToNow();
            mController.sendEvent(this, EventType.GO_TO, t, null, -1,
                    ViewType.CURRENT);
            return true;
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            try {
                cursor = this.getContentResolver()
                        .query(eventUri,projection,null,null,null,null);
    ...
    protected void onResume() {
        ...
        //invalidateOptionsMenu();//UNISOC: Modify for bug 1188044
