...
public class DeleteEventHelper {
    ...
    public void deleteAllEvents() {
        ...
        /* UNISOC: Modify for bug159665,1179179 @{ */
        if (cursor == null || cursor.getCount() == 0) {
            if (cursor != null) {
                cursor.close();
            }
            Toast.makeText(mParent,
                    mParent.getResources().getString(R.string.delete_error),
    ...
    public boolean hasEvents() {
        Uri uri = CalendarContract.Events.CONTENT_URI;
        ContentResolver cr = mParent.getContentResolver();
        /* SPRD: for Bug558012, java.lang.SecurityException: Permission Denial @{ */
        Cursor cursor = null;
        try {
            cursor = cr.query(uri,
                    EditEventHelper.EVENT_PROJECTION, null, null, null);
