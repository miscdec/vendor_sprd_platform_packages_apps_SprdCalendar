...
public class QuickResponseActivity extends ListActivity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /* SPRD: Modify for bug 634130 @{ */
        int needRequestPermissions = Utils.checkPermissions(this);
        if (0 != needRequestPermissions) {
            Intent intent = new Intent(this, QuickResponseActivity.class);
