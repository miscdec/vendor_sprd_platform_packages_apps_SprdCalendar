...
public class AsyncQueryService extends Handler {
    ...
    private void showSqliteFullNotification(){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            final NotificationChannel fullChannel = new NotificationChannel(Utils.SERVICE_NOTIFICATION_CHANNEL,
                    mContext.getString(R.string.app_label),NotificationManager.IMPORTANCE_LOW);
            mNotificationManager.createNotificationChannel(fullChannel);
            mBuilder.setChannelId(Utils.SERVICE_NOTIFICATION_CHANNEL);
        }
        /* }@ */
