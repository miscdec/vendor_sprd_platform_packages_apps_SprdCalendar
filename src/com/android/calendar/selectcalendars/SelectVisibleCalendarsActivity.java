...
public class SelectVisibleCalendarsActivity extends AbstractCalendarActivity {
    ...
    private final ContentObserver mObserver = new ContentObserver(new Handler()) {
        ...
        public void onChange(boolean selfChange) {
            mController.sendEvent(this, EventType.EVENTS_CHANGED, null, null,
                    -1, ViewType.CURRENT);
        }
    };
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mFragment = (SelectVisibleCalendarsFragment) getFragmentManager()
                .findFragmentById(R.id.main_frame);

        if (mFragment == null) {
            mFragment = new SelectVisibleCalendarsFragment(
                    R.layout.calendar_sync_item);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getActionBar().setHomeAsUpIndicator(R.drawable.ic_ab_back_holo_light);
        return true;
    }
