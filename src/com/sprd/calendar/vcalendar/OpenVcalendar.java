...
public class OpenVcalendar extends Activity {
    ...
    // Fix bug 610513 Can't parse vcs from email attachment
    ...
    public Uri doInsert(VcalendarInfo info){
        ...
        if (LOCAL_CALENDAR.equals(info.organizer) && !TextUtils.isEmpty(info.attendeeEmail)) { //UNISOC: Modify for bug1218590
    ...
    public static class OpenVcalendarDialogFragment extends DialogFragment {
        ...
        public OpenVcalendarDialogFragment() {
        }
        @Override
                    ...
                    .setPositiveButton(android.R.string.ok,
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog,
                                    ...
                                    Activity activity = getActivity();
                                    if (activity != null) {
                                        OpenVcalendar openVcalendar = (OpenVcalendar) activity;
                                        openVcalendar.waitForDialog();
                                    }
                                }
                            }).create();
        }
